...
dependencies {
    // internal
    implementation(project(":contexts:password"))
    ...
    // rest-assured 4.5.1 compatibility https://github.com/rest-assured/rest-assured/issues/1612
...
flyway {
    ...
    val port = System.getenv("POSTGRE_PORT") ?: "5432"

    url = "jdbc:postgresql://$host:$port/password_database"
    user = System.getenv("POSTGRE_USERNAME") ?: "password_username"
    password = System.getenv("POSTGRE_PASSWORD") ?: "password_password"
}
